...
class SelectDifficulty(QWidget):
    difficulty_clicked = pyqtSignal(str)
    ...
    def show_slow_mode_input(self):
        self.difficulty_clicked.emit('slow')

    def show_medium_mode_input(self):
        self.difficulty_clicked.emit('medium')

    def show_fast_mode_input(self):
        self.difficulty_clicked.emit('fast')