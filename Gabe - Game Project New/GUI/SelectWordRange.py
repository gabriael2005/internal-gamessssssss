...
from database.wordRangeManager import get_word_ranges_list

script_directory = os.path.dirname(os.path.abspath(__file__))

class SelectWorldRange(QWidget):
    buttonClicked = pyqtSignal(str)  # Custom signal to emit button text
    ...
    def init_word_ranges(self):
        ...
        for label_text in self.ranges:
            ...
            button.clicked.connect(lambda checked, text=label_text: self.on_button_clicked(text))
